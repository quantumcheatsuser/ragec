...
SaveManager:SetFolder("RageCombat")
...
local mainWindow = Library:CreateWindow("RageCombat")
...
Library:SetWatermark(('RageCombat | Paid | Lone Survival'):format(
    ));

getgenv().FurryHBELoaded = true
updatePlayers()
Library:Notify("RageCombat Loaded")
